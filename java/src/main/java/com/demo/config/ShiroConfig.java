...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager securityManager) {
		...
		filterMap.put("/user/findPwdMail.do","anon");
		filterMap.put("/user/findPwd.do","anon");
		filterMap.put("/user/resetPwd.do","anon");
		filterMap.put("/user/update.do","anon");
		filterMap.put("/user/upload-avatar.do","anon");

		// TODO 権限必要　一時テストのため
		filterMap.put("/user/getInfo.do","anon");
		filterMap.put("/user/update.do","anon");
