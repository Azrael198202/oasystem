<template>
    <div class="apply-area">
        ...
        <!-- <apply-header title="有給休暇申請"></apply-header> -->
        <applyHeader title="有給休暇申請" v-bind:reqNumber="reqNumber"></applyHeader>
        <div class="leave-num">
        ...
        <div class="apply-leave">
            <el-form ref="form" :rules="rules" :model="form" label-width="120px">
                ...
                <el-form-item prop="selectDate" label="休暇期間" v-if="holidayTimeKbn == '010'">
                    <el-date-picker
                        @blur="onBlur()"
                        @change="onClear()"
                ...
                <el-form-item prop="selectHalf" label="休暇予定日" v-if="holidayTimeKbn != '010'">
                    <el-date-picker
...
<script>
    ...
    import { getRequestHolidayList,  insertRequestHolidayList, deleteRequestHoliday, updateRequestHolidayList, leaveDayConfirm, checkNum} from '@/api/requestHoliday'
    ...
    export default {
        ...
        computed: {
            ...
            holidayType: function() {
                return this.holidayTimeKbn=='020'||this.holidayTimeKbn=='021' ? "011" : "010"
            },
        },
        ...
        methods: {
                ...
                if (valid) {
                    ...
                    selectTgtMonth(data).then(res => {
                        ...
                        if(this.falseCount >= 1){
                            ...
                            if(this.falseCount >= 1){
                                Message({
                                    message: '本日から2か月を超えて有給休暇を取得できません。',
                                    type: 'error',
                                    duration: 4000
                                })
                                return
            ...
            requestSaveData(){
                this.requestData = {
                    ...
                    requestTypeKbn: '020',
                    requestOverview: this.requestOverviewData(),
            ...
            setPaidHoliday() {
                ...
                getRequestHolidayList(data).then(res => {
                    ...
                    //  console.log(this.detailList[0].holidayTypeKbn)
                     ...
                     //  休暇予定日
                     if (this.detailList[0].holidayTimeKbn == '010') {
                     ...
                     }else if (this.detailList[0].holidayTimeKbn == '020') {
                         this.form.selectHalf = this.detailList[0].holidayPlanDay.substring(0,4) + '-' + this.detailList[0].holidayPlanDay.substring(4,6) + '-' + this.detailList[0].holidayPlanDay.substring(6,8)
                                console.log(this.form.selectHalf)
                     }else if (this.detailList[0].holidayTimeKbn == '021') {
                         this.form.selectHalf = this.detailList[0].holidayPlanDay.substring(0,4) + '-' + this.detailList[0].holidayPlanDay.substring(4,6) + '-' + this.detailList[0].holidayPlanDay.substring(6,8)
                                console.log(this.form.selectHalf)
                     }
            ...
            requestOverviewData(){
                let data
                if (this.holidayTimeKbn == "010"){
                    data = this.numSearch(this.holidayType) + '申請 '+ this.form.selectDate[0] + '～' + this.form.selectDate[1]
                }else if (this.holidayTimeKbn == "020" || this.holidayTimeKbn == "021"){
                    data = this.numSearch(this.holidayType) + '申請 '+ this.form.selectHalf
                }else{
                    Message({
                        message: '申請概要名決定処理エラー',
                        type: 'error',
                        duration: 4 * 1000
                    })
                }
